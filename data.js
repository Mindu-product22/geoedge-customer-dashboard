...
window.DASHBOARD_DATA = {
  ...
  accounts: [
    ...
    { name: "MobiReach",            portal: "mobireach.verif", contact: "Priya Nair", location: "Singapore",   product: "Verification", type: "Platform",  tier: "Gold",      region: "APAC", mrr: 6500,  csm: "Maya Stern", healthScore: 58, health: "needs-attention", renewal: "2026-08-28", autoRenew: true,  requirePO: false, churnRisk: "watch", cpm: 0.07, pricePerScan: 0.0004, packageSize: "90M scans", products: "Verification", plan: "Exec call with champion this week; fix alert-noise complaints before renewal", lastYear: "Renewed late after 6-week negotiation; 10% discount for annual prepay", riskReason: "Open alert-noise complaints, health score dipped to 58" },
