...
window.DASHBOARD_DATA = {
  ...
  accounts: [
    { name: "AdNexa",               portal: "adnexa.verif", contact: "Sarah Mitchell", location: "New York, USA",      product: "Verification", type: "Platform",  tier: "Strategic", region: "USA",  mrr: 22000, csm: "Avi B.",  healthScore: 78, health: "healthy",         renewal: "2026-09-25", autoRenew: false, requirePO: true,  churnRisk: "low", cpm: 0.09, pricePerScan: 0.0006, packageSize: "180M scans", products: "Verification, MediaGuard", plan: "Lock PO by mid-Sep; QBR on 8 Sep to present APAC expansion pricing", lastYear: "Renewed flat; negotiated discrepancy-reporting SLA after two escalations", riskReason: "Strong engagement, healthy QBR cadence, no open escalations" },
    { name: "BidCore Technologies", portal: "bidcore.verif", contact: "Lukas Weber", location: "Berlin, Germany",     product: "Verification", type: "Platform",  tier: "Strategic", region: "EU",   mrr: 16500, csm: "Dana Katz",  healthScore: 88, health: "healthy",         renewal: "2027-04-01", autoRenew: true,  requirePO: false, churnRisk: "low", cpm: 0.08, pricePerScan: 0.0005, packageSize: "140M scans", products: "Verification", plan: "Standard auto-renew track; propose multi-year at Q1 QBR", lastYear: "Renewed with 8% uplift; added second seat for EU ad-ops team", riskReason: "Health score 88, stable usage, champion actively engaged" },
    { name: "Daily Chronicle Group", portal: "chronicle.rum", contact: "James Porter", location: "Chicago, USA",    product: "RUM",          type: "Publisher", tier: "Strategic", region: "USA",  mrr: 14500, csm: "Dana Katz",  healthScore: 82, health: "healthy",         renewal: "2027-02-15", autoRenew: true,  requirePO: false, churnRisk: "low", cpm: 0.12, pricePerScan: 0.0007, packageSize: "120M imps", products: "RUM", plan: "Bundle AppHarbr SDK upsell into renewal conversation in Dec", lastYear: "Renewed early at flat rate; expanded RUM to two more sites", riskReason: "Healthy usage growth, early adopter of new features" },
    { name: "AdVantage Exchange",   portal: "advantage.rum", contact: "Emily Chen", location: "Austin, USA",     product: "RUM",          type: "Platform",  tier: "Gold",      region: "USA",  mrr: 8000,  csm: "Tom Rosen",  healthScore: 75, health: "healthy",         renewal: "2026-12-01", autoRenew: true,  requirePO: false, churnRisk: "low", cpm: 0.10, pricePerScan: 0.0006, packageSize: "80M imps", products: "RUM", plan: "Confirm auto-renew with champion in Oct; review usage vs tier", lastYear: "Renewed on auto; usage grew 20% with no plan change", riskReason: "Consistent usage, auto-renew reconfirmed last quarter" },
    { name: "Nordpress Media",      portal: "nordpress.rum", contact: "Mats Lindqvist", location: "Stockholm, Sweden",     product: "RUM",          type: "Publisher", tier: "Gold",      region: "EU",   mrr: 7900,  csm: "Avi B.",   healthScore: 84, health: "healthy",         renewal: "2027-01-10", autoRenew: true,  requirePO: false, churnRisk: "low", cpm: 0.11, pricePerScan: 0.0006, packageSize: "75M imps", products: "RUM", plan: "Pair renewal with SpecHub cross-sell demo in Nov", lastYear: "Renewed with small uplift after strong block-rate results", riskReason: "Strong block-rate results, positive sentiment from champion" },
    { name: "MobiReach",            portal: "mobireach.verif", contact: "Priya Nair", location: "Singapore",   product: "Verification", type: "Platform",  tier: "Gold",      region: "APAC", mrr: 6500,  csm: "Avi B.", healthScore: 58, health: "needs-attention", renewal: "2026-08-28", autoRenew: true,  requirePO: false, churnRisk: "watch", cpm: 0.07, pricePerScan: 0.0004, packageSize: "90M scans", products: "Verification", plan: "Exec call with champion this week; fix alert-noise complaints before renewal", lastYear: "Renewed late after 6-week negotiation; 10% discount for annual prepay", riskReason: "Open alert-noise complaints, health score dipped to 58" },
    { name: "StreamCast TV",        portal: "streamcast.rum", contact: "Kenji Watanabe", location: "Tokyo, Japan",    product: "RUM",          type: "Publisher", tier: "Gold",      region: "APAC", mrr: 6400,  csm: "Maya Stern", healthScore: 45, health: "at-risk",         renewal: "2026-10-20", autoRenew: false, requirePO: false, churnRisk: "high", cpm: 0.13, pricePerScan: 0.0008, packageSize: "60M imps", products: "RUM", plan: "Save plan active: weekly check-ins, SLA credits offered, exec sponsor engaged", lastYear: "Renewed reluctantly after integration issues; usage has declined since", riskReason: "Health 45, usage down 30% since integration issues, manual renewal" },
    { name: "PixelBridge",          portal: "pixelbridge.verif", contact: "David Alvarez", location: "San Francisco, USA", product: "Verification", type: "Platform",  tier: "Gold",      region: "USA",  mrr: 6000,  csm: "Tom Rosen",  healthScore: 80, health: "healthy",         renewal: "2026-11-01", autoRenew: true,  requirePO: true,  churnRisk: "low", cpm: 0.08, pricePerScan: 0.0005, packageSize: "70M scans", products: "Verification, AppHarbr SDK", plan: "Request PO early Oct; verify new procurement contact", lastYear: "Renewed on time; late PO nearly caused a service gap", riskReason: "Healthy adoption; PO timing is the only known friction" },
    { name: "Velocity Ads",         portal: "velocity.rum", contact: "Omer Shalev", location: "Tel Aviv, Israel",      product: "RUM",          type: "Platform",  tier: "Gold",      region: "Other",mrr: 5500,  csm: "Noa Levi",   healthScore: 64, health: "needs-attention", renewal: "2027-03-12", autoRenew: true,  requirePO: false, churnRisk: "watch", cpm: 0.10, pricePerScan: 0.0006, packageSize: "55M imps", products: "RUM", plan: "Rebuild engagement via video-verification pilot before spring", lastYear: "Renewed flat; sponsor changed mid-year, relationship needs rebuilding", riskReason: "Sponsor left mid-year, engagement dropped since March" },
    { name: "Sunrise Media House",  portal: "sunrise.rum", contact: "Grace Tan", location: "Sydney, Australia",       product: "RUM",          type: "Publisher", tier: "Gold",      region: "APAC", mrr: 4750,  csm: "Maya Stern", healthScore: 81, health: "healthy",         renewal: "2027-05-20", autoRenew: true,  requirePO: false, churnRisk: "low", cpm: 0.09, pricePerScan: 0.0005, packageSize: "50M imps", products: "RUM", plan: "On track; tie impression-tier upgrade to renewal for better unit price", lastYear: "Renewed with tier upgrade after overage discussions", riskReason: "Healthy account, overage discussions resolved amicably" },
    { name: "Spark Media Group",    portal: "sparkmedia.verif", contact: "Liam O'Brien", location: "Dublin, Ireland",  product: "Verification", type: "Platform",  tier: "Gold",      region: "Other",mrr: 4500,  csm: "Dana Katz",  healthScore: 72, health: "healthy",         renewal: "2027-06-30", autoRenew: true,  requirePO: false, churnRisk: "low", cpm: 0.08, pricePerScan: 0.0005, packageSize: "45M scans", products: "Verification", plan: "Finish onboarding cleanly; monthly adoption reviews until usage sticks", lastYear: "New logo — first renewal cycle coming up", riskReason: "New logo mid-onboarding, tracking to plan" },
    { name: "Quantum Ads Network",  portal: "quantumads.verif", contact: "Ji-woo Park", location: "Seoul, South Korea",  product: "Verification", type: "Platform",  tier: "Silver",    region: "APAC", mrr: 5000,  csm: "Noa Levi",   healthScore: 66, health: "needs-attention", renewal: "2027-07-15", autoRenew: true,  requirePO: false, churnRisk: "low", cpm: 0.06, pricePerScan: 0.0004, packageSize: "50M scans", products: "Verification", plan: "Unblock tag deployment; establish success metrics before first renewal", lastYear: "New logo — first renewal cycle coming up", riskReason: "Onboarding blocker open, but renewal is 11 months out" },
    { name: "PlayGrid Media",       portal: "playgrid.rum", contact: "Sofia Rossi", location: "Milan, Italy",      product: "RUM",          type: "Platform",  tier: "Silver",    region: "EU",   mrr: 2400,  csm: "Avi B.",  healthScore: 77, health: "healthy",         renewal: "2027-02-28", autoRenew: true,  requirePO: false, churnRisk: "low", cpm: 0.09, pricePerScan: 0.0005, packageSize: "24M imps", products: "RUM", plan: "Standard track; quarterly usage reviews", lastYear: "Renewed on auto with no issues", riskReason: "Stable low-touch account, no open issues" },
    { name: "TrafficLane",          portal: "trafficlane.verif", contact: "Tomas Novak", location: "Prague, Czechia", product: "Verification", type: "Platform",  tier: "Silver",    region: "EU",   mrr: 1900,  csm: "Dana Katz",  healthScore: 38, health: "at-risk",         renewal: "2026-09-04", autoRenew: false, requirePO: false, churnRisk: "high", cpm: 0.05, pricePerScan: 0.0003, packageSize: "20M scans", products: "Verification", plan: "Proposal sent; decision call 20 Aug; 15% save offer approved", lastYear: "Renewed after downgrade from Gold; support tickets doubled since", riskReason: "Support tickets doubled, downgraded last year, health 38" },
    { name: "MetroNews Digital",    portal: "metronews.rum", contact: "Claire Dubois", location: "Paris, France",     product: "RUM",          type: "Publisher", tier: "Silver",    region: "EU",   mrr: 1800,  csm: "Noa Levi",   healthScore: 61, health: "needs-attention", renewal: "2026-10-02", autoRenew: true,  requirePO: false, churnRisk: "watch", cpm: 0.08, pricePerScan: 0.0005, packageSize: "18M imps", products: "RUM", plan: "Address block-rate complaints in Sep health check; confirm auto-renew stands", lastYear: "Renewed on auto; two escalations since March", riskReason: "Two escalations since March, open block-rate complaints" }
  ],
  ...
  /* owner = GeoEdge team member; est = annual value; monthly = monthly amount; openDate = when opened.
     Open stages (Discovery/Demo/Trial/Commercial Discussion/Negotiation/Review/Nurture/Not Qualified)
     feed the pipeline chart; Closed Won/Lost feed the Won/Lost tiles. */
  opportunities: [
    /* Negotiation/Review — high probability (green, chart baseline) */
    { account: "AdNexa",                owner: "Tom Rosen",  stage: "Negotiation/Review",    oppName: "APAC team rollout",            monthly: 4000, est: 48000, probability: 72,  openDate: "2026-06-12", closeDate: "2026-09-18", nextStep: "Send updated pricing for APAC seats",    nextStepUpdate: "2026-08-04" },
    { account: "BidCore Technologies",  owner: "Dana Katz",  stage: "Negotiation/Review",    oppName: "Multi-year commit",            monthly: 3000, est: 36000, probability: 85,  openDate: "2026-05-30", closeDate: "2026-10-28", nextStep: "Legal reviewing MSA redlines",           nextStepUpdate: "2026-08-11" },
    { account: "Velocity Ads",          owner: "Noa Levi",   stage: "Negotiation/Review",    oppName: "Video verification module",    monthly: 1500, est: 18000, probability: 78,  openDate: "2026-07-18", closeDate: "2026-11-20", nextStep: "Confirm video inventory volumes",        nextStepUpdate: "2026-08-01" },
    /* Commercial Discussion — medium probability (amber) */
    { account: "Daily Chronicle Group", owner: "Dana Katz",  stage: "Commercial Discussion", oppName: "AppHarbr SDK upsell",          monthly: 3000, est: 36000, probability: 55,  openDate: "2026-07-01", closeDate: "2026-10-15", nextStep: "Schedule technical review with ad-ops",  nextStepUpdate: "2026-08-05" },
    { account: "Nordpress Media",       owner: "Noa Levi",   stage: "Commercial Discussion", oppName: "SpecHub cross-sell",           monthly: 1000, est: 12000, probability: 50,  openDate: "2026-06-28", closeDate: "2026-11-05", nextStep: "Share SpecHub ROI one-pager",            nextStepUpdate: "2026-07-30" },
    { account: "PixelBridge",           owner: "Tom Rosen",  stage: "Commercial Discussion", oppName: "MediaGuard cross-sell",        monthly: 1400, est: 16800, probability: 62,  openDate: "2026-06-20", closeDate: "2026-09-25", nextStep: "Send commercial proposal",               nextStepUpdate: "2026-08-09" },
    /* Trial — medium probability (amber) */
    { account: "Spark Media Group",     owner: "Dana Katz",  stage: "Trial",                 oppName: "Verification trial expansion", monthly: 1300, est: 15600, probability: 52,  openDate: "2026-06-30", closeDate: "2026-10-20", nextStep: "Review trial block-rate results",        nextStepUpdate: "2026-08-08" },
    { account: "Sunrise Media House",   owner: "Maya Stern", stage: "Trial",                 oppName: "RUM trial — second region",    monthly: 1000, est: 12000, probability: 55,  openDate: "2026-07-15", closeDate: "2026-09-25", nextStep: "Extend trial to APAC inventory",         nextStepUpdate: "2026-08-03" },
    /* Demo — low/medium probability */
    { account: "MetroNews Digital",     owner: "Noa Levi",   stage: "Demo",                  oppName: "SpecHub demo pilot",           monthly: 900,  est: 10800, probability: 42,  openDate: "2026-07-10", closeDate: "2026-10-06", nextStep: "Run live demo with ad-ops lead",         nextStepUpdate: "2026-08-07" },
    { account: "AdVantage Exchange",    owner: "Tom Rosen",  stage: "Demo",                  oppName: "AppHarbr SDK demo",            monthly: 1100, est: 13200, probability: 38,  openDate: "2026-07-28", closeDate: "2026-12-14", nextStep: "Book technical demo session",            nextStepUpdate: "2026-08-06" },
    /* Discovery — low probability (red, chart top) */
    { account: "MobiReach",             owner: "Maya Stern", stage: "Discovery",             oppName: "Mobile SDK expansion",         monthly: 1200, est: 14400, probability: 30,  openDate: "2026-07-20", closeDate: "2026-09-12", nextStep: "Qualify budget and timeline",            nextStepUpdate: "2026-08-05" },
    { account: "PlayGrid Media",        owner: "Dana Katz",  stage: "Discovery",             oppName: "RUM add-on for new sites",     monthly: 800,  est: 9600,  probability: 25,  openDate: "2026-07-25", closeDate: "2026-11-10", nextStep: "Map new sites to be protected",          nextStepUpdate: "2026-08-02" },
    { account: "Quantum Ads Network",   owner: "Noa Levi",   stage: "Discovery",             oppName: "Verification for video",       monthly: 1500, est: 18000, probability: 35,  openDate: "2026-08-01", closeDate: "2027-01-20", nextStep: "Discovery call with product team",       nextStepUpdate: "2026-08-10" },
    /* Nurture — low probability (red) */
    { account: "TrafficLane",           owner: "Dana Katz",  stage: "Nurture",               oppName: "Re-engagement — future upgrade", monthly: 600, est: 7200,  probability: 15,  openDate: "2026-07-01", closeDate: "2027-02-15", nextStep: "Quarterly check-in scheduled",           nextStepUpdate: "2026-07-29" },
    { account: "StreamCast TV",         owner: "Maya Stern", stage: "Nurture",               oppName: "Win-back nurture",             monthly: 700,  est: 8400,  probability: 20,  openDate: "2026-07-08", closeDate: "2026-12-30", nextStep: "Share case study, keep warm",            nextStepUpdate: "2026-08-01" },
    /* Not Qualified — very low probability (red) */
    { account: "Velocity Ads",          owner: "Noa Levi",   stage: "Not Qualified",         oppName: "Budget not confirmed",         monthly: 500,  est: 6000,  probability: 8,   openDate: "2026-07-20", closeDate: "2026-12-20", nextStep: "Revisit when budget approved",           nextStepUpdate: "2026-08-04" },
    { account: "PlayGrid Media",        owner: "Dana Katz",  stage: "Not Qualified",         oppName: "No current need",              monthly: 400,  est: 4800,  probability: 10,  openDate: "2026-08-02", closeDate: "2026-10-25", nextStep: "Close-lost unless need emerges",         nextStepUpdate: "2026-08-09" },
    /* Closed Won — feed the Won this quarter tile */
    { account: "BidCore Technologies",  owner: "Dana Katz",  stage: "Closed Won",            oppName: "Multi-year renewal + seats",   monthly: 2500, est: 30000, probability: 100, openDate: "2026-05-10", closeDate: "2026-07-18", nextStep: "Kickoff expansion onboarding",           nextStepUpdate: "2026-07-18" },
    { account: "PixelBridge",           owner: "Tom Rosen",  stage: "Closed Won",            oppName: "AppHarbr SDK add-on",          monthly: 1200, est: 14400, probability: 100, openDate: "2026-05-20", closeDate: "2026-08-05", nextStep: "Schedule SDK integration",               nextStepUpdate: "2026-08-05" },
    { account: "AdVantage Exchange",    owner: "Tom Rosen",  stage: "Closed Won",            oppName: "RUM tier upgrade",             monthly: 1000, est: 12000, probability: 100, openDate: "2026-05-25", closeDate: "2026-08-10", nextStep: "Confirm new tier billing",               nextStepUpdate: "2026-08-10" },
    /* Closed Lost — feed the Lost this quarter tile */
    { account: "StreamCast TV",         owner: "Maya Stern", stage: "Closed Lost",           oppName: "RUM tier upgrade",             monthly: 900,  est: 10800, probability: 0,   openDate: "2026-05-15", closeDate: "2026-07-28", nextStep: "Revisit next fiscal year",               nextStepUpdate: "2026-07-28" },
